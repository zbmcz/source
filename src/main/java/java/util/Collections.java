...
public class Collections {
     ...
     * This method runs in linear time.
     *
     * 拷贝所有的元素, 从一个集合到另一个集合. 操作之后, 每一个被拷贝的元素在目标集合中索引和它在源集合中的索引是一样的.
     * 目标集合的元素数量(size)必须大于等于源集合的元素数量(否则抛异常). 如果目标集合的长度更大, 那么目标集合中的"剩余元素"将不会受到影响.
     *
    ...
    public static <T> void copy(List<? super T> dest, List<? extends T> src) {
        ...
        // 源集合的元素数量小于 "拷贝阈值" 或者 源集合/目标集合是 RandomAccess 的实例 ???
